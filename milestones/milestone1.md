...
The team was able to easily come up with a project idea and agree with it. Communication was on point.

### 2. What were some challenges your group faced in this unit?

A challenge we faced was having to understand the instructions for this milestone. At first it was unclear but we eventually understood what we had to do.

### 3. What additional support will you need in upcoming units as you continue to work on your final project?

We will just need to find out if using external API's is allowed for this capstone project.
